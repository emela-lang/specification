...
```json
{
  ...
  "dependencies": {
    "std": {
      "git": "https://github.com/emela-lang/std.git",
...
1. project manifest dependency または explicit package set に含まれる `std` package。
2. toolchain binary に embedded された stdlib fallback。
